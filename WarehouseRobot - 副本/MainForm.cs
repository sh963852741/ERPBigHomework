...
namespace WarehouseRobot
{
    public partial class MainForm : Form
    {
        ...
        private HashSet<RHPoint> obstaclePoints = new();
        private HashSet<RHPoint> beginPoints = new();
        private RHPoint[] taskPoints = new RHPoint[2];
        ...
        private void PrintFinalMap()
        {
            ...
            {
                RHPoint pos = robot.CurrentPosition;
            ...
            foreach (RHPoint pos in beginPoints)
            {
        ...
        private void SetCellColor(RHPoint point, Color color)
        {
        ...
        private void DrawButton_Click(object sender, EventArgs e)
        {
            ...
            {
                grid = GridGenerator.GetGrid(out IList<RHPoint> obstacle, maxRow, maxCol);
        ...
        private void SimulatePanel_Click(object sender, EventArgs e)
        {
            ...
            else if (mapState == MapState.SettingTaskPoint)
            {
                ...
                RHPoint p1 = new(x + 1, y + 1);
                if (taskPoints[0] == p1)
                {
                    // 取消当前点
                    taskPoints[0] = RHPoint.Empty;
                    SetCellColor(p, defaultColor);
                }
                else if (taskPoints[1] == p1)
                {
                    // 取消当前点
                    taskPoints[1] = RHPoint.Empty;
                    SetCellColor(p, defaultColor);
                }
                else if (taskPoints[0] == RHPoint.Empty)
                {
                    taskPoints[0] = p1;
                }
                else if (taskPoints[1] == RHPoint.Empty)
                {
                    taskPoints[1] = p1;
                }
                else
